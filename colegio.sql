...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-12-2023 a las 01:35:19
...
INSERT INTO `grados` (`ID_grado`, `NombreGrado`, `CodigoPuerta`) VALUES
(1, 'Primero', '1'),
(2, 'Segundo', '2'),
(3, 'Tercero', '3'),
(4, 'Cuarto', '4'),
...
--
ALTER TABLE `imparte`
  MODIFY `ID_imparte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
